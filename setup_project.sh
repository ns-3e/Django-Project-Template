...
# Create Django apps
apps=("home" "accounts" "billing" "products" "analytics" "support" "notifications" "content" "integrations" "security" "settings_app" "onboarding" "custom_features")
...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="{% url 'home:home' %}">$PROJECT_NAME</a>
